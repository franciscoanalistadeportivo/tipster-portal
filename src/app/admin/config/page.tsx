...
export default function ConfigPage() {
  ...
  const getCategoryIcon = (cat: string) => {
    switch (cat) {
      ...
      case 'seo': return <Globe className="w-5 h-5 text-blue-400" />;
  ...
  // Filtrar solo categorías de configuración general
