...
// ─── Datos reales del sistema (sin montos inventados) ───
const HIGHLIGHTS = [
  ...
  return (
    <div className="min-h-screen flex" style={{ background: '#0B0F1A' }}>
      ...
      <div className="hidden lg:flex lg:w-[55%] relative overflow-hidden flex-col justify-between p-12"
        ...
        {/* Highlights carousel — datos reales del sistema */}
        <div className="relative z-10"
          ...
          <div className="rounded-xl p-5 relative overflow-hidden"
            ...
            <div className="flex items-start gap-3">
              <div className="text-2xl flex-shrink-0 mt-0.5">{HIGHLIGHTS[activeHighlight].stat.split(' ')[0]}</div>
              <div className="flex-1">
                ...
                <div className="flex items-center justify-between">
                  <p className="text-xs text-[#64748B]">— {HIGHLIGHTS[activeHighlight].label}</p>
            ...
            <div className="flex gap-1.5 justify-center mt-4">
              {HIGHLIGHTS.map((_, i) => (
                <div key={i} className="w-1.5 h-1.5 rounded-full transition-all duration-300"
                  style={{
                    background: i === activeHighlight ? '#00D1B2' : 'rgba(100, 116, 139, 0.3)',
                    width: i === activeHighlight ? '16px' : '6px',
                  }} />
              ))}
            </div>
          </div>
